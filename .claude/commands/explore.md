...
**Work-It:** Product behavior, routes, auth flow, and client/server layout are summarized in **`CLAUDE.md`**. Read it (and any files the user `@` mentions) before assuming how a feature should work.
