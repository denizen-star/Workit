...
const MEDIA: Record<string, ExerciseMedia> = {
  ...
  "bodyweight squats or tempo squats": { images: gym.hotel, videoId: "MeiiS8eQc7o" },
  "bodyweight single-leg rdls": { images: gym.hotel, videoId: "qVhui08Jcy4" },
  "bodyweight walking or reverse lunges": { images: gym.hotel, videoId: "HIM0GrawvAU" },
  "lying hamstring floor slides": { images: gym.hotel, videoId: "AlTI3igOaLw" },
  "single-leg bodyweight calf raises": { images: gym.hotel, videoId: "wdOkFomQNp8" },
  "side plank or towel iso press": { images: gym.core, videoId: "ASdvN_XEl_c" },
  ...
  "single-leg glute bridges": { images: gym.hotel, videoId: "wPM8icPu6H8" },
  "bodyweight step-ups or sissy squats": { images: gym.hotel, videoId: "YyvSfViT6H0" },
  "loaded water jug / backpack carries": { images: gym.hotel, videoId: "fkA-eYYvU5E" },
