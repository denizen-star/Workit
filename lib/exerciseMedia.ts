...
const MEDIA: Record<string, ExerciseMedia> = {
  ...
  "hanging knee raises or ab wheel rollouts": {
    ...
    videoId: "G6a5267YpHM",
    videos: [
      { id: "G6a5267YpHM", label: "Hanging Knee Raises" },
  ...
  "doorframe iso curls or loaded backpack curls": { images: gym.hotel, videoId: "XE_pHwbst04" },
  ...
  "dumbbell or barbell shrugs": { images: gym.pull, videoId: "xiLT85G_GuU" },
  "straight-arm pulldowns or dumbbell pullovers": { images: gym.pull, videoId: "duHQk2PxNos" },
  "lying triceps extensions (skull crushers)": { images: gym.dumbbell, videoId: "tj81tVq3wLo" },
